...
function FlashTaskBar.OnInit (self)
	...
	local CheckIfFlyingEnded = function (tickObject)
		if (not UnitOnTaxi ("player")) then
			...
			FlashTaskBar:Msg ("fly point reached.")
		end
	end
...
--------> chat scan
	...
	function FlashTaskBar:DoNotFlashOnWhisper()
		--FlashTaskBar:RegisterEvent ("CHAT_MSG_WHISPER", do_whisper_scan)
		--FlashTaskBar:RegisterEvent ("CHAT_MSG_BN_WHISPER", do_whisper_scan)
		_G.ChatFrame_MessageEventHandler = ChatFrame_MessageEventHandler_WithNoFlash
	end
	
	function FlashTaskBar:EnableFlashOnWhisper()
		--FlashTaskBar:UnregisterEvent ("CHAT_MSG_WHISPER")
		--FlashTaskBar:UnregisterEvent ("CHAT_MSG_BN_WHISPER")
